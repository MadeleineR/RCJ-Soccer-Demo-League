...
package position_data.protos;

public final class MessagesVision {
  private MessagesVision() {}
  ...
  public static final class SSL_WrapperPacket extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return position_data.protos.MessagesVision.internal_static_SSL_WrapperPacket_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return position_data.protos.MessagesVision.internal_static_SSL_WrapperPacket_fieldAccessorTable;
    }
    ...
    public static position_data.protos.MessagesVision.SSL_WrapperPacket parseFrom(
    ...
    public static position_data.protos.MessagesVision.SSL_WrapperPacket parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static position_data.protos.MessagesVision.SSL_WrapperPacket parseFrom(
    ...
    public static position_data.protos.MessagesVision.SSL_WrapperPacket parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static position_data.protos.MessagesVision.SSL_WrapperPacket parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static position_data.protos.MessagesVision.SSL_WrapperPacket parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(position_data.protos.MessagesVision.SSL_WrapperPacket prototype) {
    ...
    public static final class Builder extends
       ...
       implements position_data.protos.MessagesVision.SSL_WrapperPacketOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return position_data.protos.MessagesVision.internal_static_SSL_WrapperPacket_descriptor;
      }
      ...
      // Construct using position_data.protos.MessagesVision.SSL_WrapperPacket.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return position_data.protos.MessagesVision.SSL_WrapperPacket.getDescriptor();
      }
      
      public position_data.protos.MessagesVision.SSL_WrapperPacket getDefaultInstanceForType() {
        return position_data.protos.MessagesVision.SSL_WrapperPacket.getDefaultInstance();
      }
      
      public position_data.protos.MessagesVision.SSL_WrapperPacket build() {
        position_data.protos.MessagesVision.SSL_WrapperPacket result = buildPartial();
      ...
      private position_data.protos.MessagesVision.SSL_WrapperPacket buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        position_data.protos.MessagesVision.SSL_WrapperPacket result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public position_data.protos.MessagesVision.SSL_WrapperPacket buildPartial() {
        position_data.protos.MessagesVision.SSL_WrapperPacket result = new position_data.protos.MessagesVision.SSL_WrapperPacket(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof position_data.protos.MessagesVision.SSL_WrapperPacket) {
          return mergeFrom((position_data.protos.MessagesVision.SSL_WrapperPacket)other);
        } else {
      ...
      public Builder mergeFrom(position_data.protos.MessagesVision.SSL_WrapperPacket other) {
        if (other == position_data.protos.MessagesVision.SSL_WrapperPacket.getDefaultInstance()) return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "metryDataB&\n\024position_data.protosB\016Messa" +
      "gesVision"
    };
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_SSL_WrapperPacket_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              position_data.protos.MessagesVision.SSL_WrapperPacket.class,
              position_data.protos.MessagesVision.SSL_WrapperPacket.Builder.class);
          return null;
        }
      };
